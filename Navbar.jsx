...
export default function Navbar() {
  ...
  return <header className="fixed inset-x-0 top-0 z-50 border-b border-[#1A3355]/80 bg-[#050E1D]/90 backdrop-blur-xl">
    <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5">
      <Link to="/" className="flex items-center gap-3"><span className="grid h-11 w-11 place-items-center rounded-full border border-[#C8965A]/50 bg-[#C8965A]/10 text-xl">🧭</span><span><b className="block text-[#F5F0E8] [font-family:'Sacramento',_system-ui] text-3xl">Rihla</b><small className="block text-right text-[#C8965A] text-2xl [font-family:'Architects_Daughter',_system-ui]">رحلة</small></span></Link>
